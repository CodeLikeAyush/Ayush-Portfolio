...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div style={{ border: "8px double white", borderRadius: "100%", height: "65px", width: "65px", position: "fixed", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", bottom: "1em", right: "1em",padding:"30px 30px", zIndex: "5", background: "#c45200",userSelect:"none" }}>
