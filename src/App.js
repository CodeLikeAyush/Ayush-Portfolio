...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div style={{ boxShadow: "black 1px 1px 5px -1px", borderRadius: "100%", height: "65px", width: "65px", position: "fixed", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", bottom: "1em", right: "1em", padding: "30px 30px", zIndex: "5", background: "#c45200", userSelect: "none" }}>
